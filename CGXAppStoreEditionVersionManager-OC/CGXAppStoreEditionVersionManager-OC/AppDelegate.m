...
//
//  Created by MacMini-1 on 2019/6/17.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [CGXAppStoreEditionVersionManager checkNewEditionWithAppID:@"1234567890" CustomAlert:^(CGXAppStoreInfoModel *appInfo) {
        ...
        UIAlertAction *ignoreAction = [UIAlertAction actionWithTitle:@"稍后再说" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
